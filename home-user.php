...
<head>
    ...
    <title>letsbyk/<?php echo $_SESSION['uname'];?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        header ul li a[href="home-user.php"] {
            font-size: 27px;
            font-weight: bold;
...
<body>
    ...
    <section>
        <div class="poster"> 
            ...
            <div class="btn">
                <button onclick='window.location.href="locate-user.php"'>Get Started!...</button> <button onclick='window.location.href="https://youtu.be/l2w1vjkg-qg"'>Watch Intro &nbsp;<i class="fa fa-play-circle"></i></button>
            </div>
        </div>
    </section>
    <section>
    ...
    <section>
        <div class="main1">
            <div class="main1-content">
                ...
                <button onclick='window.location.href="about-user.php"'>know more</button>
            </div>
            <figure>
    ...
    <section>
        <div class="stay-in-touch">Stay in Touch!.....
            ...
            <form align="center" action="home-user.php" method="POST"><input type="email" name="email" id="email" placeholder="Email"
